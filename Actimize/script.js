...
function insertNewRecord(data) {
    ...
    cell3.innerHTML = data.relationship;
...
function onEdit(td) {
    ...
    document.getElementById("relationship").value = selectedRow.cells[2].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[2].innerHTML = formData.relationship;
